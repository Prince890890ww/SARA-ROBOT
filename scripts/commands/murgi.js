...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আপনি কাকে চুদতে চান এমন 1 জনকে @ম্যানশন করেন", event.threadID);
...
setTimeout(() => {a({body: "Hi সুজনের জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi সুজনের জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
